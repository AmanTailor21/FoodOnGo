                    ...
                    <div class="col-sm-12" style="padding: 20px; border-radius: 25px; background-color: #000000">
                        ...
                        <div class="row" style="padding-top: 10px;">
                            ...
                            <div class="col-sm-1 ml-0">
                                <h4 style="color: red">
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtemail" Style="padding: 0px;" Text="*" ToolTip="Please Enter Email"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="validateEmail" runat="server" Text="*" ToolTip="Invalid email." ControlToValidate="txtemail" ValidationExpression="^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$" />
                                </h4>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-1 ml-0">
                                <h4 style="color: red">
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtpass" Style="padding: 0px;" Text="*" ToolTip="Please Enter Password"></asp:RequiredFieldValidator></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3"></div>
                            ...
                            <div class="col-sm-1 ml-0">
                                <h4 style="color: red">
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtconpass" Style="padding: 0px;" Text="*" ToolTip="Please Enter Confirm Password"></asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="CompareValidator" ControlToValidate="txtconPass" ControlToCompare="txtpass" ToolTip="Password Does not Match" Text="*"></asp:CompareValidator></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3"></div>
                            <div class="col-sm-6" style="padding: 10px;">
                                <asp:TextBox runat="server" ID="txtmob" CssClass="textboxReg" MaxLength="10" Placeholder="Mobile Number"></asp:TextBox>&nbsp;
                            </div>
                            
                            <div class="col-sm-1 ml-0">
                                <h4 style="color: red">
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtmob" Style="padding: 0px;" Text="*" ToolTip="Please Enter Mobile Number"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator runat="server" Text="*" Tooltip="Invalid Mobile Number" ControlToValidate="txtmob" ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>
                                </h4> 
                            </div>
                        </div>
