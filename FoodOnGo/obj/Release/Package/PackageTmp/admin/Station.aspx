    ...
    <div class="col-sm-12" style="width: 100%; height: 100%; border-radius: 10px 60px">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-sm-8" style="margin-top: 1%; padding: 10px; background-color: white; border-bottom-style: groove; border-top: thin; border-radius: 200px">
                    <div class="row">
                        <div class="col-sm-1"></div>
                        <div class="col-sm-4">
                            <asp:Label ID="Label1" runat="server" Text="Station Code"></asp:Label>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row" style="padding-top: 1%">
                        <div class="col-sm-1"></div>
                        <div class="col-sm-4">
                            <asp:Label ID="lblSName" runat="server" Text="Station Name"></asp:Label>
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-12" style="margin-top: 1%; padding: 1%; background-color: white; border-radius: 200px;">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-8">
                            <asp:Repeater ID="rptStation" runat="server" OnItemCommand="RptStation_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:Label Text='<%#Eval("StationCode")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label Text='<%#Eval("StationName")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
