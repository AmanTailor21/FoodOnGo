                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="row" style="padding-top: 1%">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-4">
                                    <asp:Label ID="lbl" runat="server" Text="Train Code"></asp:Label>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row" style="padding-top: 1%">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-4">
                                    <asp:Label ID="lblTN" runat="server" Text="Train Name"></asp:Label>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div class="row" style="padding-top: 1%">
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-4">
                                            <asp:Label ID="Label1" runat="server" Text="Start Station"></asp:Label>
                                        </div>
                                        <div class="col-sm-2">
                                            <asp:DropDownList ID="ddlStartCode" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlStartCode_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="ddlStartStation" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlStartStation_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div>
                                            <h4 style="color: red">
                                    ...
                                    <div class="row" style="padding-top: 1%">
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-4">
                                            <asp:Label ID="Label2" runat="server" Text="End Station"></asp:Label>
                                        </div>
                                        <div class="col-sm-2">
                                            <asp:DropDownList ID="ddlEndCode" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlEndCode_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="ddlEndStation" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlEndStation_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div>
                                            <h4 style="color: red">
                                    ...
                                    <div class="row" style="padding-top: 1%">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlDurationHH" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlEndCode_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlDurationMM" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlEndStation_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div>
                                            <h4 style="color: red">
                                    ...
                                    <div class="row" style="padding-top: 1%">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlStartTimeHH" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlEndCode_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlStartTimeMM" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlEndStation_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div>
                                            <h4 style="color: red">
                                    ...
                                    <div class="row" style="padding-top: 1%">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlEndTimeHH" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlEndCode_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlEndTimeMM" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlEndStation_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div>
                                            <h4 style="color: red">
                        ...
                        <div class="col-sm-12">
                            <asp:Repeater ID="rptTrain" runat="server" OnItemCommand="RptTrain_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:Label Text='<%#Eval("TrainCode")+"-"+Eval("TrainName")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label Text='<%#Eval("SS")+"-"+Eval("ES")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label Text='<%#Eval("StartTime")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label Text='<%#Eval("EndTime")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
