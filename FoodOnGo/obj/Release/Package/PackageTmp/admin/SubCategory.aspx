...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-sm-12" style="width: 100%; height: 100%; border-radius: 10px 60px">
        ...
        <div class="row">
            <div class="col-sm-12" style="margin-top: 1%; padding: 1%; background-color: white; border-radius: 250px;">
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-8">
                            <asp:Repeater ID="rptSubCategory" runat="server" OnItemCommand="RptSubCategory_ItemCommand">
                                <HeaderTemplate>
                                    <table class="table table-responsive" style="width: 100%; border: 1px solid lightgrey">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label Text='<%#Eval("SubCategoryName")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
