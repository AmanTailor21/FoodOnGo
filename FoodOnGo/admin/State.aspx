<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="State.aspx.cs" Inherits="FoodOnGo.admin.State" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-sm-12" style="width: 100%; height: 100%; border-radius: 10px 60px">
        <div class="row">
            <div class="col-sm-12">
                <a style="position:absolute; right:45%; top:-35px; color:ActiveCaption;"><h1>State</h1></a>
                <div class="col-sm-2"></div>
                <div class="col-sm-8" style="margin-top: 1%; padding: 10px;background-color:rgba(255,255,255,0.6); border-bottom-style: groove; border-top: thin; border-radius: 500px">
                    <div class="row">
                        <div class="col-sm-1"></div>
                        <div class="col-sm-4">
                            <b><asp:Label ID="lbl" runat="server" Text="State Name"></asp:Label></b>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div>
                            <h4 style="color:red">
                            <asp:RequiredFieldValidator runat="server" ID="rfvState" ControlToValidate="txtSName" ErrorMessage="*" ToolTip="Please Fill State Name..."></asp:RequiredFieldValidator>
                            </h4>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12" style="margin-top: 1%; padding: 1%;background-color:rgba(255,255,255,0.6); border-radius: 150px;">
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="row" style="padding-top: 1%;">
                    ...
                    <div class="col-sm-8">
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <b><asp:Literal ID="ltrMsg" runat="server"></asp:Literal></b>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <asp:Repeater ID="rptState" runat="server" OnItemCommand="RptState_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <b><asp:Label Text='<%#Eval("StateName")%>' runat="server"></asp:Label></b>
                                        </td>
                                        <td>
                                            <asp:LinkButton CausesValidation="false" runat="server" CssClass='<%#Eval("Status").ToString() == "True" ? "btn btn-success":"btn btn-warning" %>' CommandName="status" CommandArgument='<%#Eval("StateId")%>' ToolTip='<%#Eval("Status").ToString() == "True" ? "Status-ON":"Status-OFF" %>'>
                                    <center>
                                        ...
                                        <td>
                                            <asp:LinkButton CausesValidation="false" runat="server" CssClass="btn btn-primary" CommandName="edit" CommandArgument='<%#Eval("StateId")%>' ToolTip="Edit"><i class="fa fa-edit"></i></asp:LinkButton>
                                            <asp:LinkButton CausesValidation="false" runat="server" CssClass="btn btn-danger" CommandName="delete" CommandArgument='<%#Eval("StateId")%>' ToolTip="Delete"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
