                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <div class="row" style="height: 75px;background-color:rgba(0,128,0,0.6); color: white; text-align: center;">
                            <a href="todayreport.aspx"><asp:Label runat="server" ID="TodayOrder" style="text-decoration:none;color:white" Font-Size="X-Large"></asp:Label></a>
                        </div>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="row" style="height: 75px; background-color:rgba(0,128,0,0.6); color: white; text-align: center;">
                            <a href="monthlyreport.aspx"><asp:Label runat="server" ID="MonthOrder" style="text-decoration:none;color:white" Font-Size="X-Large"></asp:Label></a>
                        </div>
                    </div>
                    <div class="col-sm-3">
