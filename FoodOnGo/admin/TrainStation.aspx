...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-sm-12" style="width: 100%; height: 100%; border-radius: 10px 60px">
        <div class="row">
            <div class="col-sm-12">
                <a style="position: absolute; right: 38%; top: -35px; color: ActiveCaption;">
                    <h1>TrainStation</h1>
                </a>
                        ...
                        <div class="col-sm-10">
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div class="row" style="padding-top: 1%">
                                        ...
                                        <div class="col-sm-4">
                                            <b>
                                                <asp:Label ID="lbl" runat="server" Text="Train"></asp:Label></b>
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="row" style="padding-top: 1%">
                                        ...
                                        <div class="col-sm-4">
                                            <b>
                                                <asp:Label ID="lblTN" runat="server" Text="Station"></asp:Label></b>
                                        </div>
                                        <div class="col-sm-2">
                                            <b>
                                                <asp:DropDownList ID="ddlStationCode" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlStationCode_SelectedIndexChanged"></asp:DropDownList></b>
                                        </div>
                                        <div class="col-sm-4">
                                            <b>
                                                <asp:DropDownList ID="ddlStation" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlStation_SelectedIndexChanged"></asp:DropDownList></b>
                                        </div>
                                    </div>
                                    <div class="row" style="padding-top: 1%">
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-4">
                                            <b>
                                                <asp:Label ID="Label6" runat="server" Text="Arrival Time"></asp:Label></b>
                                        </div>
                                        <div class="col-sm-3">
                                            <b>
                                                <asp:DropDownList ID="ddlArrivalTimeHH" runat="server" AutoPostBack="true" CssClass="form-control"></asp:DropDownList></b>
                                        </div>
                                        <div class="col-sm-3">
                                            <b>
                                                <asp:DropDownList ID="ddlArrivalTimeMM" runat="server" AutoPostBack="true" CssClass="form-control"></asp:DropDownList></b>
                                        </div>
                                        <div>
                                            <h4 style="color: red">
                                    ...
                                    <div class="row" style="padding-top: 1%">
                                        ...
                                        <div class="col-sm-4">
                                            <b>
                                                <asp:Label ID="Label7" runat="server" Text="Departure Time"></asp:Label></b>
                                        </div>
                                        <div class="col-sm-3">
                                            <b>
                                                <asp:DropDownList ID="ddlDepartureTimeHH" runat="server" AutoPostBack="true" CssClass="form-control"></asp:DropDownList></b>
                                        </div>
                                        <div class="col-sm-3">
                                            <b>
                                                <asp:DropDownList ID="ddlDepartureTimeMM" runat="server" AutoPostBack="true" CssClass="form-control"></asp:DropDownList></b>
                                        </div>
                                        <div>
                                            <h4 style="color: red">
                                    ...
                                    <div class="row" style="padding-top: 1%">
                                        ...
                                        <div class="col-sm-4">
                                            <b>
                                                <asp:Label ID="Label8" runat="server" Text="Halt Time"></asp:Label></b>
                                        </div>
                                        <div class="col-sm-3">
                            ...
                            <div class="row" style="padding-top: 1%">
                                ...
                                <div class="col-sm-4" style="padding-top: 10px">
                                    <b>
                                        <asp:Label ID="lblWarn" runat="server" CssClass="text-danger" Text=""></asp:Label></b>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-1"></div>
                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="text-left">
                                        <b>
                                            <asp:Literal ID="ltrRecordFound" runat="server"></asp:Literal></b>
                                    </div>
                                </div>
                                <%--<div class="col-sm-2">
                                    <label>Search</label>
                            ...
                            <asp:Repeater ID="rptTrainStation" runat="server" OnItemCommand="RptTrainStation_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <b>
                                                <asp:Label Text='<%#Eval("SC")+"-"+Eval("SN")%>' runat="server"></asp:Label><b>
                                        </td>
                                        <td>
                                            <b>
                                                <asp:Label Text='<%#Eval("SAT")+"-"+Eval("SDT")%>' runat="server"></asp:Label><b>
                                        </td>
                                        <td>
                                            <b>
                                                <asp:Label Text='<%#Eval("ST")%>' runat="server"></asp:Label><b>
                                        </td>
                                        <td>
