<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="FoodOnGo.admin.Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-sm-12" style="width: 100%; height: 100%; border-radius: 10px 60px">
        <div class="row">
            <div class="col-sm-12">
                 <a style="position:absolute; right:42%; top:-35px; color:ActiveCaption;"><h1>Category</h1></a>
                <div class="col-sm-2"></div>
               
                <div class="col-sm-8" style="margin-top: 1%; padding: 10px; background-color:rgba(255,255,255,0.6); border-top: thin; border-radius: 500px">
                    <div class="row">
                        ...
                        <div>
                            <h4 style="color: red">
                                <asp:RequiredFieldValidator runat="server" ID="rfvCategory" ControlToValidate="txtCName" ErrorMessage="*" ToolTip="Please Fill Category Name..."></asp:RequiredFieldValidator>
                            </h4>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <asp:Repeater ID="rptCategory" runat="server" OnItemCommand="RptCategory_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:LinkButton CausesValidation="false" runat="server" CssClass='<%#Eval("Status").ToString() == "True" ? "btn btn-success":"btn btn-warning" %>' CommandName="status" CommandArgument='<%#Eval("CategoryId")%>' ToolTip='<%#Eval("Status").ToString() == "True" ? "Status-ON":"Status-OFF" %>'>
                                    <center>
                                        <%#Eval("Status").ToString()=="True"?"<i class='fa fa-toggle-on'></i>":"<i class='fa fa-toggle-off'></i>" %>
                                            ...
                                            <td>
                                                <asp:LinkButton CausesValidation="false" runat="server" CssClass="btn btn-primary" CommandName="edit" CommandArgument='<%#Eval("CategoryId")%>' ToolTip="Edit"><i class="fa fa-edit"></i></asp:LinkButton>
                                                <asp:LinkButton CausesValidation="false" runat="server" CssClass="btn btn-danger" CommandName="delete" CommandArgument='<%#Eval("CategoryId")%>' ToolTip="Delete"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
